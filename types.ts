...
export interface ZoneImageConfig {
  id: string;
  label: string;
  guideImage?: string;
}
...
export interface ProcessingState {
  isAnalyzing: boolean;
  error: string | null;
  imageUrl: string | null; // Keep for backward compatibility or single image
  imageUrls?: Record<string, string>; // Map of image config ID to base64 URL
}
